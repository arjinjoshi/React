...
const TodoDetailView = () => {
    ...
    const {todos, handleToggle, deleteHandler} = useTodoContext();
    ...
    <div className='mt-10 flex flex-col justify-center items-center'>
                        ...
                        <div className='w-300 bg-slate-400 rounded-2xl p-3 flex items-center justify-between px-10'>
                            <div className='flex gap-4 items-center'>
                                <input className='w-4 h-4 cursor-pointer' type="checkbox" checked = {activeTodo.isCompleted} onChange={() => handleToggle(activeTodo.id)} />
